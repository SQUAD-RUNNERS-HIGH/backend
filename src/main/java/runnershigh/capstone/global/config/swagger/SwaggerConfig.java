...
import runnershigh.capstone.global.response.ErrorResponse;
import runnershigh.capstone.global.response.SuccessResponse;

@Configuration
@OpenAPIDefinition(
    info =
    @Info(
        title = "Runner's High API Docs",
        description = "2025년 캡스톤 디자인 Runner's High API Docs",
        version = "v1"))
